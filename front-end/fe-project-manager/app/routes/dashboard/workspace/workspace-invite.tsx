      ...
      <div className='flex items-center justify-center h-screen'>
        <Card className='max-w-md'>
          <CardHeader>
            ...
            <CardDescription>This workspace invitation is invalid or has expired.</CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <div className='flex items-center justify-center h-screen'>
      <Card className='max-w-md w-full'>
        <CardHeader>
          ...
          <CardDescription>
            You've been invited to join the "<strong>{workspace.name}</strong>" workspace.
          </CardDescription>
        </CardHeader>
